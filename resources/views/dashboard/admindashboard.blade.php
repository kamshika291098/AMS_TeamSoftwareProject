...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: rgba(86,138,161);">
                        <!-- Brand Logo -->
   ...
   <div class="sidebar" style="margin-top: -65px">
				...
				<div class="modal-dialog" role="dialog">
                  ...
                  {{Auth::user()->role}}
						...
						<div class="modal-footer">
								<a type="button" id="model-btn" class="btn" style="background-color: rgba(86,138,161); color:white" href="{{route('logout')}}"><i class="fa-solid fa-arrow-right-from-bracket"></i> Log out</a>
						</div>
					</div>
				</div>
			</div>
      ...
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
               <a href="#" class="nav-link">
                  <i class="nav-icon fa fa-thin fa-shop fa-shake"  style="color: rgb(255, 255, 255); --fa-animation-duration: 3s;"></i>
            ...
            <li class="nav-item">
               <a href="#" class="nav-link">
                  <i class="nav-icon fa fa-users-between-lines fa-shake"  style="color: rgb(255, 255, 255); --fa-animation-duration: 3s;"></i>
                     <p> Incharges<i class="right fas fa-angle-left" style="color: rgb(255, 255, 255);"></i></p>
               </a>
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{route('incharges.create')}}" class="nav-link">
                         <i class="nav-icon fa fa-plus" style="color: rgb(255, 255, 255);"></i>
                           <p>Add</p>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="{{route('incharges.index')}}" class="nav-link">
                        <i class="nav-icon fa fa-cog" style="color: rgb(255, 255, 255);"></i>
                           <p>Manage</p>
                     </a>
                  </li>
