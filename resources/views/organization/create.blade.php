...
<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0" style="color: rgb(86,138,161);"><span class="fa fa-thin fa-shop fa-beat" style="--fa-animation-duration: 3s;"></span> Add Organization</h1>
         </div>
                  <!-- /.col -->
         <div class="col-sm-6">
...
<section class="content">
    <div class="text-right">
      <a class="btn btn-md btn-info" href="{{route('organizations.index')}}"><i class="fa fa fa-list"></i> Organizations List</a>
    </div>
    ...
    <div class="card card-info">
        ...
        <form  action="{{route('organizations.store')}}" method="post">
				...
				<div class="row">
                    ...
                    <div class="col-md-12">
						<div class="form-group">
                            ...
                            <div class="col-md-4">
							<input type="text" name="organizationname" class="form-control" style="border-color: rgba(86,138,161);" placeholder="Organization Name">
						    </div>
					    </div> 
                    </div>
                </div>  
            ...
            <div class="card-footer" style="display: flex; justify-content: center;">
                <button type="submit" class="btn" style="background-color: rgba(86,138,161); color:white;"><i class="fa fa-thin fa-shop"></i><i class="fa fa-plus fa-2xs"></i><b> Save Organization</b></button>
            </div>
        </form>
	</div>
</div>
